    ...
    _forgotPassword(){
        ...
        if(this.state._email_validation && this.state.password_validation && this.state.confirmpassword_validation){
          if(this.state.password != this.state.confirm_password){
            ...
            POST(SERVER() + 'user/mobile/forgetPassword', data).then(({body}) => {
                if(!body.status){
      ...
      <ScrollView style = {{backgroundColor:'#fff'}}>
            <View style={styles.container}>
                ...
                <View style = {styles.input_text_view_password}>
                    <TextInput  style = {styles.input_text_style}  placeholder="Neues Kennwort"  underlineColorAndroid='transparent'  secureTextEntry={true} onChangeText={(password) => this.password_validation(password)} />
                </View>
                <View style = {styles.input_text_view_password}>
                ...
                <View style = {styles.register_view}>
                      <Button block style={styles.btn_style} onPress={ () => this._forgotPassword() }>
                        <Text style={[styles.text, {color: '#fff'}]}>Kennwort speichern</Text>
                      </Button>
                    </View> 
